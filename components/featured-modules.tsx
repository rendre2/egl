          ...
          {session && userStats && (
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8 max-w-2xl mx-auto">
              ...
              <div className="bg-orange-50 p-4 rounded-lg">
                <div className="text-2xl font-bold text-orange-600">{userStats.totalModules}</div>
                <div className="text-sm text-gray-600">Total modules</div>
              </div>
              <div className="bg-green-50 p-4 rounded-lg">
                <div className="text-2xl font-bold text-green-600">{Math.floor(userStats.totalWatchTime / 60)}</div>
                <div className="text-sm text-gray-600">Minutes regardées</div>
              </div>
